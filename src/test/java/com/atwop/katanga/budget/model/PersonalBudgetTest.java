...
public class PersonalBudgetTest {
    ...
    void givenAmountWhenAmountIsNullThenIsFalse() {
        PersonalBudget personalBudget = new PersonalBudget(null, null);
    ...
    void givenAmountWhenAmountIsZeroThenIsFalse() {
        PersonalBudget personalBudget = new PersonalBudget(0F, null);
    ...
    void givenUserIdWhenUserIdIsEmptyThenIsFalse() {
        PersonalBudget personalBudget = new PersonalBudget(200F, "");
    ...
    void givenAmountAndUserIdWhenAreValidsThenIsTrue() {
        PersonalBudget personalBudget = new PersonalBudget(200F, "FAKE-ID");
